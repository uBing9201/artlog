...
import com.playdata.couponservice.common.dto.CommonErrorDto;
...
public class CommonExceptionHandler {
    ...
    /**
     * @param e 쿠폰 등록 과정에서 발생하는 유효성 예외
     * @return 쿠폰 등록 실패 처리
     */
    @ExceptionHandler(InvalidCouponRegisterException.class)
    public ResponseEntity<?> invalidCouponRegisterHandler(InvalidCouponRegisterException e) {
        e.printStackTrace();
    ...
    /**
     * @param e 쿠폰 접근 과정에서 발생하는 유효성 예외
     * @return 쿠폰 접근 실패 처리
     */
    @ExceptionHandler(InvalidCouponAccessException.class)
    public ResponseEntity<?> invalidCouponAccessHandler(InvalidCouponAccessException e) {
        e.printStackTrace();
        CommonErrorDto errorDto
